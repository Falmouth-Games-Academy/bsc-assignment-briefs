...
%
    \criterion{Novice Competency Threshold}{---}
		...
		%\grade{}
		\gradespan{5}{
		  \par All criteria are at least `adequate'.
                       \par Satisfactory presentations are delivered.
		  \par Adequate participation in peer review exercises, with enough to enable meaningful review alongside critical and constructive comments provided to peers.
