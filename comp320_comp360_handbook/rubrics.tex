...
%
    \criterion{Computing Artefact}{---}
        ...
        \grade The computing artefact is clearly described in some detail, and nearly all features are distinguished from other work, and easily measured.
            \par Requirements correspond to the proposed research.
        \grade The computing artefact is clearly described in much detail, and all features are distinguished from other work, and easily measured.
            \par Requirements clearly correspond to the proposed research.
        \grade The computing artefact is clearly described in considerable detail, and all features are distinguished from other work, and easily measured.
            \par Requirements clearly and comprehensively correspond to the proposed research.
        \grade The computing artefact is clearly described in significant detail, and all features are distinguished from other work, and easily measured.
            \par Requirements clearly and comprehensively correspond to the proposed research.
%
