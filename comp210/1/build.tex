...
For this assignment, you are required to design, implement and then evaluate an interface. 
Your interface concept should build upon an existing screen based project such as the your 
COMP240 World Creation Project or another game of your choosing. However, you are required 
to port the interface to an immersive context such as augmented reality (AR) or virtual 
reality (VR). Once you have developed a functional prototype, you will use a HCI method 
to compare and contrast the new interface with the original screen based version. You must 
choose between a \textbf{semi-structured interview} or \textbf{survey} for this assignment 
and then provide justification for your choice in the final video. Analytics data could be 
used as part of the discussion although this is not required by the brief. 
...
\begin{enumerate}[label=(\Alph*)]
    ...
    \item \textbf{Evaluate} the final interface by:
		...
		\item \textbf{interpreting} the data (including analytics if you have some);
...
\begin{markingrubric}
    ...
    \criterion{Architect: \linebreak Innovation and creative flair }{5\%}
...
%            
    \criterion{Architect: \linebreak Functionality of the Interface }{20\%}
    ...
    \criterion{Architect: \linebreak Sophistication: \par Software \par Electronics \par Networking}{10\%}
...
%
    \criterion{Research: \linebreak Adequacy of Justification of Methods and Practice}{10\%}
    ...
    \criterion{Research: \linebreak Depth of Discussion about Key Usability and User Experience Issues }{15\%}
    ...
    \criterion{Research: \linebreak Ability to Discern Key Usability and User Experience Issues}{10\%}
