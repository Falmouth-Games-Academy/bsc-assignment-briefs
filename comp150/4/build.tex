...
\begin{enumerate}[label=(\Alph*)]
    \item \textbf{Maintain} a series of brief weekly reports (about 100-200 words) that will:
    	\begin{enumerate}[label=\roman*.]
    		\item \textbf{describe} your progress each week;
...
This assignment is a \textbf{reflective writing task} and so regular reflection through blogging on \texttt{journal.falmouth.ac.uk} is expected. Setup your blog on our \textit{Journal} platform and fork the \textit{GitHub} repository at the following URL:
...
\begin{enumerate}[label=(\alph*)]
	...
	\item Aspirations are made clear, or a tentative direction is suggested;
	\item Five key skills and associated challenges are identified;
