...
\todo[inline]{\textbf{Important Note:} There is a publisher's brief for this project. Your project's deliverables \textbf{must} cohere to the brief in order to pass.}
...
\begin{markingrubric}
    \firstcriterion{Sprint Reviews}{40\%}
        ...
        \gradespan{5}{The student participates in all sprint reviews.
             ...
             \par The prototype confirms to the publisher's brief.}
%
...
\begin{markingrubric}
    \firstcriterion{Basic Competency Threshold}{40\%}
        ...
        \gradespan{5}{A broadly appropriate individual and group pitch is delivered.
        	\par There is a reasonable coherence between the pitch and the publisher's brief.}
%
