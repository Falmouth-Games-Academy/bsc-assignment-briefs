...
\begin{markingrubric}
    ...
    \criterion{Task completion}{30\%}
        ...
        \gradespan{4} All ``Research'' and ``Production'' levels on Sernimir II, Sernimir IV, and Danopth, except for the optional challenge level ``In-Place Swap'', have been completed and correctly submitted via YouTube and GitHub.
