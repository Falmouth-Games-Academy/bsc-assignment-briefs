...
%
    \firstcriterion{Worksheets}{20\% $\times$ 5 worksheets}
        \grade\fail	A reasonable attempt at the worksheet is not submitted by the deadline.
				\par				A score of 90\% is not achieved on the online quiz.
        \gradespan{5}{A reasonable attempt at the worksheet is submitted by the deadline.
				\par Please see individual worksheets for marking criteria.
        \par A score of at least 90\% is achieved on the online quiz.
				}
\end{markingrubric}
