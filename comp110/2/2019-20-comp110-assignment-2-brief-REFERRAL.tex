...
This \textbf{referral} assignment is formed of one part:

\begin{enumerate}[label=(\Alph*)]
    \item \textbf{Write} a research journal, of at most 1500 words, that will:
    	\begin{enumerate}[label=(\roman*)]
    		\item \textbf{summarise} the key contributions of the assigned paper;
    		\item \textbf{discuss} the context and influence of the paper, with reference to other
...
\indent \url{https://www.overleaf.com/read/qdnfdyphtrdt}

Alternatively, fork the following GitHub repository:
...
Part A consists of a \textbf{single summative submission}. This work is \textbf{individual} and will be assessed on a \textbf{criterion-referenced} basis
using the criteria listed in the marking rubric at the end of this document.

\clearpage

To complete Part A, read the paper:

E.~W. Dijkstra, ``Go to statement considered harmful,'' \emph{Communications of
  the ACM}, vol.~11, no.~3, pp. 147--148, 1968.

A PDF of this paper is available online via the reading list:
...
which summarises the paper and its influence on the field of computing
...
%
	\firstcriterion{Basic Competency Threshold}{30\%}
		...
		\gradespan{5}{The student demonstrates adequate research and information skills.
...
%
    \criterion{RESEARCH: Breadth of reading}{15\%}
        \grade\fail	The assigned article is not referenced.
        \par		Fewer than 2 additional sources, in addition to the assigned paper, are referenced.
        \grade		The assigned paper is referenced.
        \par		An additional 2 sources, in addition to the assigned paper, are referenced.
        \grade		The assigned paper is referenced.
        \par		An additional 5 sources, in addition to the assigned paper, are referenced.
        \grade		The assigned paper is referenced.
        \par		An additional 8 sources, in addition to the assigned paper, are referenced.
        \grade		The assigned paper is referenced.
        \par		An additional 12 sources, in addition to the assigned paper, are referenced.
        \grade		The assigned paper is referenced.
        \par		An additional 16 sources, in addition to the assigned paper, are referenced.
%
