...
\begin{enumerate}[label=(\Alph*)]
	...
	\end{enumerate}
    \item \textbf{Write}, as a \textbf{group}, blog posts on the GitHub Pages site which:
    	\begin{enumerate}[label=\roman*.]
			\item \textbf{describe} the architecture and engineering of the game;
    		\item \textbf{analyse} the quality of \textbf{EACH} component in the game.
	\end{enumerate}	
...
You will receive immediate \textbf{informal feedback} from your \textbf{peers} and your \textit{tutor}.
...
Part D consists of \textbf{multiple formative submissions}. This work is \textbf{collaborative} and will be assessed on a \textbf{threshold} basis. The following criteria are used to determine a pass or fail:

\begin{enumerate}[label=(\alph*)]
	\item The blog is live and available online;
	\item The development team are introduced and credited  in the first blog post;
		\item There are further blog post for \textbf{EACH} team member, {EACH} describing the game component they have made;
	\item Sufficient analysis of software quality is evident;
	\item Appropriate UML diagrams and metrics are evident in \textbf{EACH} blog post.
\end{enumerate}

To complete Part D, analyse the engineering quality of components in the project and incorproate the findings into the GitHub pages site. Showcase this in the relevant presentation session.
...
You will receive \textbf{informal feedback} during Part G \textbf{and formal feedback} three weeks after the final deadline.
...
\begin{enumerate}[label=(\alph*)]
	...
	\item Description and analysis of engineering quality is sufficient \textbf{and} accurate
\end{enumerate}
...
\todo[inline]{\textbf{Note:} In addition to sprint retrospectives and peer-review activities, your product owners will track your individual contributions using the version control and SparkPLUS systems---alongside other criteria which they will note down in product owner meetings. These factors are detailed in the additional guidence section below.}
