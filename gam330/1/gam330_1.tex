...
\marginpicture{flavour_pic}{
    \textit{Kick Your Astronaut} is a well-scoped party game produced by Falmouth's final-year students and released commercially on Steam.
}
...
\begin{markingrubric}
%
    \firstcriterion{Individual Specialist Contribution}{20\%}
...
%
    \criterion{Commercia Awareness}{10\%}
...
%
    \criterion{Specialist Insight}{10\%}
...
%
    \criterion{Demo Quality}{10\% $\ddagger$}
