...
%\end{marginquote}
\marginpicture{necrodancer}{
    \emph{Crypt of the NecroDancer} uses the open-source \emph{Essentia} library (\url{http://essentia.upf.edu/})
    to analyse player-provided music tracks and synchronise gameplay with the beat.
}
...
\end{marginquote}
\marginpicture{angelina}{
    \emph{ANGELINA}, by Falmouth University researcher Michael Cook, uses fifteen different APIs and web services to automatically design entirely new games.
}
...
%
    \criterion{Appropriateness of user stories and sprint plans}{10\%}
