...
In this assignment, you will produce a Mathematics library which can be used by a Computer Graphics API such as OpenGL. You as a class will contribute to this library and build on it over the course of the module. To aid in the development of the library you will also create a wiki and also produce code documentation in the doxygen format.
...
\indent \url{https://github.com/Falmouth-Games-Academy/comp220-journal}
...
To complete Part A, \textbf{select} and \textbf{read at least six} papers from the academic literature on computer graphics.
