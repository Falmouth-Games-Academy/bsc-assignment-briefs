...
\begin{enumerate}[label=(\Alph*)]
    \item \textbf{Write} a draft plan in the wiki for the library, that will:
    	\begin{enumerate}[label=(\roman*)]
    		\item \textbf{summarise} the User Stories for the library
...
Part A consists of \textbf{multiple formative submissions}. This work is \textbf{collaborative} and will be assessed on a \textbf{threshold} basis.
