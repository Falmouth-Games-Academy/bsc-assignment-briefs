...
\title{Portfolio of Graphics Components}
...
which will demonstrate a selection of different 3D computer graphics techniques that are likely to appear in a modern game engine.
...
Your final product will be a meaningful portfolio piece, which you can use in future to demonstrate your mastery of these techniques. This portfolio piece will be built up using a series of tasks will give you a foundational framework for the rest of the assignment which will involve independent research and experimentation.

This assignment is formed of several parts:
\begin{enumerate}[label=(\Alph*)]
	\item \textbf{Write} a 2-page proposal document that will:
		...
		\end{enumerate}
	\item \textbf{Setup} the project framework;
	\item \textbf{Implement} a basic scene \textbf{and} a camera;
	\item \textbf{Enhance} the scene with the \textbf{TWO} additional components that you described in your proposal (i.e., special effects);
...
Modify the \texttt{.gitignore} to the defaults for \textbf{C++} and \textbf{Visual Studio}.
...
To complete Part A, prepare the proposal using any word processing tool.
To help illustrate your intended aesthetic, your handout may include images and/or links to online videos.

Show the handout to your \textbf{tutor} for immediate \textbf{informal feedback} in the relevant session in Week 3.

Once you have completed Part A, progress onto Parts B---C. See the handouts on the Learning Space for more details.  

\subsection*{Part B}

Part B consists of a \textbf{single formative submission}. This work is \textbf{individual} and will be assessed on a \textbf{criterion-referenced} basis. Please refer to the marking rubric at the end of this document for further detail.

To complete Part B, follow the video tutorials on LearningSpace and prepare the project framework using any integrated development environment. Ensure that you commit and push your code your project repository.

Show the code to your \textbf{tutor} for immediate \textbf{informal feedback} in the relevant session in Week 5.

\subsection*{Part C}

Part C consists of a \textbf{single formative submission}. This work is \textbf{individual} and will be assessed on a \textbf{criterion-referenced} basis. Please refer to the marking rubric at the end of this document for further detail.

To complete Part C, follow the video tutorials on LearningSpace and implement the basic scene and camera. Ensure that you commit and push your code your project repository.

Show the code to your \textbf{tutor} for immediate \textbf{informal feedback} in the relevant session in Week 7.

\subsection*{Part D}

Part D consists of a \textbf{single summative submission}. This work is \textbf{individual} and will be assessed on a \textbf{criterion-referenced} basis. Please refer to the marking rubric at the end of this document for further detail.

To complete Part D, follow the video tutorials on LearningSpace and implement the basic scene and camera. Ensure that you commit and push your code your project repository. Then, upload a copy of your repository to the LearningSpace as a \texttt{.zip} file

You will received \textbf{formal feedback} from your \textbf{tutor} within 3 weeks.

\subsection*{Part E}

Part E is a \textbf{single summative submission}. This is \textbf{individual} work will be assessed on a \textbf{threshold} basis. The following criteria are used to determine a pass or fail: 
...
To complete Part E, prepare a practical demonstration. You may find it useful to prepare a video and to leverage it to showcase your work during the viva. Ensure that the final build and source code is also readily available. Then, attend the scheduled viva session. 
...
\begin{markingrubric}
	...
	\gradespan{5}{See handout for details}
	%
