...
\begin{enumerate}[label=(\Alph*)]
	\item \textbf{Write} a \textbf{2-page} handout that will:
...
Show the handout to your \textbf{tutor} for immediate \textbf{informal feedback} in the \textbf{Seminar in Week 2}
