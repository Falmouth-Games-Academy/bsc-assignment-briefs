...
\todo[inline]{\textbf{Please Note:} Falmouth University Games Academy have partnered with DitigalOcean to provide \textbf{EACH} of you, individually, with your own remote server on their cloud platform. You will receive login details after the distributed processing task. You \textbf{MUST} act in an ethical and professional manner when using this platform as well as act with due care and courtesy should any issues arise. If you encounter technical difficulties, please contact \texttt{games.techs@falmouth.ac.uk} in the first instance.}
