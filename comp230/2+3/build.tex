...
\begin{markingrubric}
    \firstcriterion{Sprint Reviews}{40\%}
        \gradespan{1}{\fail Inadequate participation in sprint reviews or breach of academic integrity.}
        \gradespan{5}{The student participates adequately in all sprint reviews (excepting mitigating circumstances). A meaningfully playable build is available in most sprint reviews.}
%
...
%
    \criterion{Specialist Contribution (Technical)}{30\% $\dagger$}
