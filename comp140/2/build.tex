...
\begin{markingrubric}
	...
	\gradespan{5}{Adequate ability to generate ideas, problem solving, concepts, technical competency and proposals in response to set briefs and/or self-initiated activity.
		...
		\par A report and a poster has been completed.
		\par No breaches of academic integrity.
	}
	%
	\criterion{ARCHITECT: \\UML Diagrams}{15\%}
	...
	%
	\criterion{ARCHITECT: \\Description of Software Architecture}{20\%}
	...
	%
	\criterion{ARCHITECT: \\Description of hardware design}{20\%}
