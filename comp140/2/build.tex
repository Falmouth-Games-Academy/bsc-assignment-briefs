...
\begin{enumerate}[label=(\Alph*)]
	...
	\item \textbf{Revise} the \textbf{1 page} propsoal  and poster based on feedback and submit on the \textbf{hand-in} date, this is due for the \textbf{Report Peer Review} in \textbf{Week 10}. 
