...
\begin{document}
	...
	To give you a wide brief and accommodate a borad range of applications you can choose from one of two contracts:
\begin{enumerate}
	\item You have been commissioned to develop a game controller and game for a keynote expo event that pushes the boundaries of what is possible with common domestic objects and gameplay. Create a game that utilises everyday objects as interfaces to a game world.
	\item You have been commissioned to develop an interactive exhibit for the Natural History Musueum that explores the interaction between the natural word and the digital. Create a digital environment that is influenced and effected by real world sensors and vice versa.
