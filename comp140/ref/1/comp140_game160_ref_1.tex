...
In this assignment, you will work as an individual to develop a small game and will be controlled by a custom controller, \textbf{Please note you don't need to develop the controller for this coursework}. When working on the development of the game, controller will consist of two potentiometers, 1 button and 6 LEDs.
