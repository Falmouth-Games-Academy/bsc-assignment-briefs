...
You should complete a pull request before the hand-in. Feedback will be given in the pull request and 3 weeks after the final hand-in
...
To complete Part B, revise the design of your game \& controller Then, upload a \texttt{.zip} file of to LearningSpace before the hand-in.
