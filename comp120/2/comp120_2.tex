...
You are being expected to not only \textit{transform} and \textit{repurpose} existing encodings (i.e. existing melodies and sound effects), but generate new encodings from primitive input. When using audio you have not authored yourself, the source should be noted in the GitHub README.md file. 
...
\rubrichead{Criteria marked $\ddagger$ are shared by the pair. All other criteria are marked individually.}
\begin{markingrubric}
%
    \firstcriterion{Basic Competency Threshold}{40\%}
        \gradespan{1}{\fail Insufficent evidence of engagement and/or working output.}
        \gradespan{5}{Considerable engagement with version control, commesurate with at least three or more commits per week, and engagement in peer review on GitHub. 
        	\par An executable and working version is submitted, with enough work available to hold a meaningful discussion.
	\par Clear evidence of programming knowledge and communication skills at least at the level of basic competency.
	\par Clear evidence of communication skills and an ability to reflect on performance at least at the level of basic competency.
...
%
    \criterion{Functional Coherence}{5\% $\ddagger$}
...
%
    \criterion{Creative Flair}{10\% $\ddagger$}
        \grade\fail No creativity.
            \par A clone of an existing work with mere cosmetic alterations.
        \grade Little creativity.
            \par Derivative of existing works with minor alterations.
        \grade Some creativity.
            \par Derivative of existing works with major alterations.
        \grade Much creativity.
            \par Somewhat novel, with some divergence and/or subversion.
        \grade Considerable creativity.
            \par Reasonably novel, with much divergence and/or subversion.
        \grade Significant creativity.
            \par Highly novel, demonstrating considerable divergence and/or subversion.
%
