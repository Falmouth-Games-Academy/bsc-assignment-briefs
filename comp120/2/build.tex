...
\begin{enumerate}[label=(\Alph*)]
	...
	\end{enumerate}
    \item \textbf{Write}, as a \textbf{pair}, a draft computer program in Unity / C# that will:
    	\begin{enumerate}[label=\roman*.]
	...
	\end{enumerate}
    \item \textbf{Write}, as an \textbf{individual}, a final computer program in Unity / C# that will:
    	\begin{enumerate}[label=\roman*.]
...
Modify the \texttt{.gitignore} to the defaults for your programming language. Please, also ensure that you add editor-specific files and folders to \texttt{.gitignore}. 
...
You can and should go beyond the techniques introduced in the lectures and the Guzdial book (e.g. researching algorithms for producing or manipulating graphics). The solutions must be written in Unity / C#.
...
%
	...
	\par All reviews provided to peers are constructive, are of suitable depth, and confer a sufficient volume of actionable advice.
	\par Version control has been used throughout the project.
	\par A range of programming constructs are demonstrated --- e.g., sequence, assignment, branching, iteration, functions.
	\par A range of appropriate data strucutres are demonstrated --- e.g., arrays, maps, linked lists, trees, stacks.
	\par A range of simple OO constructs are demonstrated --- e.g., object definition through structs and classes, inheritance and polymorphism.
