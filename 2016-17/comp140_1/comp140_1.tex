...
Part D consists of \textbf{multiple formative submissions}. This work is \textbf{individual} but with a \textbf{collaborative} component, and will be assessed on a \textbf{criterion-referenced} basis.
...
\begin{markingrubric}
%
    \firstcriterion{Formative submissions}{Threshold 5\%}
        \gradespan{5}{\fail Formative submissions for Part B have been signed off less frequently than once every three weeks.}
        \grade 		Formative submissions for Part B have been signed off at least once every three weeks.
%
...
%
    \criterion{Synthesis}{20\%}
        ...
        \par		Connections are inferential in nature.
