...
\marginpicture{flavour_pic}{
    An algorithm for visualising sound and music such as Beethoven.
}

In this assignment, you are required to write a computer program that will `tinker' with computer generated audio in a creative way.
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item \textbf{Write}, as a \textbf{pair}, a draft computer program in Python that will:
    	\begin{enumerate}[label=\roman*.]
    		...
    		\item \textbf{implement} \textbf{six} algorithms for tinkering audio;
	\end{enumerate}
...
%
    \firstcriterion{Functional Coherence}{5\%}
        ...
        \grade 		At least six algorithms have been implemented successfully.
        ...
        \grade 		At least six algorithms have been implemented successfully.
            \par		There are no obvious logical errors.
                   \par		The brief has been satisfied.
%
    \criterion{Sophistication}{15\% $\dagger$}
...
%
    \criterion{Creative Flair}{10\% $\dagger$}
