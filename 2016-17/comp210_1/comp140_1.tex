...
Although the choice of game interface is down to you, careful consideration must be given to select an interface that is complex and interesting enough to warrant interrogation. There are two main methods of evaluation that you are required to implement for this assignment but you may research and implement others

You may one of the games being developed by students on the BA Digital Games course; \textbf{or}
...
\subsection*{A. Heuristic Evaluation}
...
\subsection*{B. Cognitive Walkthrough}
...
\subsection*{C. Synthesize findings }
