...
In this assignment, you are required to \textbf{choose} an existing game interface to \textbf{evaluate} with a focus on usability and user-experience.
Although the choice of game interface is down to you, careful consideration must be given to select an interface that is complex and interesting enough to warrant interrogation. The main method of evaluation that you are required to implement for this assignment is a heuristic evaluation, although you are encouraged to explore other evaluation methods  {\color{red}to enhance your understanding of the strengths and weakness of the game interface in regards to usabilty and user-experience.}  You might also choose to implement cognitive walkthrough, task analysis, user-story mapping  or any other methods that you feel are relevant. 
