...
Although the choice of game interface is down to you, careful consideration must be given to select an interface that is complex and interesting enough to warrant interrogation. There are two methods of evaluation that you are required to implement for this assignment. 
{\color{red}Inside the evaluation you are required to create a user story map. }




This assignment is formed of \textbf{four} parts.
The summative submission has \textbf{one} part: an electronic component and a physical component.
