...
\todo{how will this make you a better game dev -- games is a fast-moving field and keeping up is important}
...
\begin{enumerate}[label=\Alph*.]
    \item \textbf{Read} at least $n$ papers from the scientific literature on computing.
    	\todo{additional guidance: One paper will be suggested in class every two weeks; this is the bare minimum that you should read.
    ...
    \item \textbf{Write} a journal entry for each paper you read. The journal entry should record your thoughts on the paper,
    	which may include but not necessarily be limited to: \todo{move into additional guidance}
    	...
    	\end{enumerate}
    \item \textbf{Collate} your individual journal entries and \textbf{synthesise} them into a cohesive report. \todo{combine with part B}
...
This assignment is an \textbf{academic writing task} and \textbf{wiki task} \todo{is this the best term? Define in course handbook}. Fork the GitHub repository at the following URL:
...
%
    \criterion{Breadth of reading}{15\%}
        \grade\fail	No articles are referenced. \todo[inline]{numbers?}
        \grade		\todo[inline]{all 6} Some but not all of the suggested articles are referenced.
        \grade		\todo[inline]{6 + 6} All of the suggested articles are referenced.
        \par		No other relevant scholarly articles are referenced.
        \grade		\todo[inline]{6 + 12} All of the suggested articles are referenced.
...
%
    \criterion{Synthesis}{20\%}
        ...
        \grade		A$^*$ evaluative skills \todo[inline]{bloom's taxonomy kind of or kraftwohl's taxonomy?}
%
    \criterion{Community engagement}{15\%}
        ...
        \par		\todo[inline]{good quality contributions}
        ...
        \par		\todo[inline]{really good quality contributions}
        ...
        \par		\todo[inline]{academically sound and well-reasoned contributions}
...
%
    \criterion{Appropriateness of journal structure}{5\%}
        ...
        \par 		There is a clear and well-constructed introduction and conclusion. \todo[inline]{are intro+conc needed for journals?}
        \grade 		There is much structure, highlighting the key themes.
