...
\marginpicture{flavour_pic}{
    Do not underestimate the breadth of game architecture. It spans more than just the object-orientated structure of the game, including its underlying engine, libraries, platforms, services, servers, databases, and so on.
}
