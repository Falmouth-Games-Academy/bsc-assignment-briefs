...
\marginpicture{flavour_pic}{
    Do not underestimate the breadth of game architecture. It spans more than just the classes in the game client. It includes its underlying engine, libraries, platforms, services, servers, databases, and so on.
}
