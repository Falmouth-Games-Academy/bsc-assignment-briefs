...
The sucess of a digital game is not just determined by the fun of its design, but also by the soundness of its architecture. Put simply, games with serious bugs do not sell. As such, the value of software engineering principles cannot be emphasised enough! You will reflect upon these principles through the lens of a game development project that mirrors industry practice.
...
\begin{enumerate}[label=(\Alph*)]
    ...
    \item \textbf{Prepare}, as an \textbf{individual}, an A3 research-style poster that:
    	\begin{enumerate}[label=\roman*.]
    		...
    		\item as well as \textbf{describe one} algorithm that you have implemented. 
	\end{enumerate}
    \item \textbf{Present}, as a \textbf{group}, a `technical demo` which will:
    	\begin{enumerate}[label=\roman*.]
    		\item \textbf{clarify} the technical content of your posters;
...
\begin{enumerate}[label=(\alph*)]
	...
	\item There is no overlap with other members of the team
\end{enumerate}
