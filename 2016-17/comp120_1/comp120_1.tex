...
You are being expected to \textit{transform} and \textit{repurpose} encodings (i.e. generate audio). However, you may create your own images if desired. When using images you have not authored yourself, the source should be noted in the GitHub README.md file. 
