...
In this assignment, you are required to implement an algorithm that will process data in a \textit{distributed} manner, taking advantage of client-server interaction and multi-threading.
...
\begin{enumerate}[label=(\Alph*)]
	...
	\end{enumerate}
    \item \textbf{Implement}, as a \textbf{pair}, a draft program, in a language of your choice, that will:
    	\begin{enumerate}[label=\roman*.]
