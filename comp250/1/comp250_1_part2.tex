...
\begin{enumerate}
	...
	\item If the submitted bot cannot be compiled on the tournament server, it receives the lowest possible score.
	...
	\item Bots \textbf{must not} create additional threads or processes, perform computations on the GPU, or perform network access.
		Any bot found to be doing these will be disqualified from the tournament.
	...
	\item \textbf{Any attempt} to compromise the security of the tournament server,
		...
		This is at the discretion of the Module Leader.
\end{enumerate}
