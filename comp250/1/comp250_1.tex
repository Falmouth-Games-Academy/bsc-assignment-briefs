...
\begin{itemize}
	\item A component integrating one or more artificial intelligence (AI) techniques into a game;
	\item An AI bot which can play a simple real-time strategy (RTS) game in competition with other bots.
\end{itemize}
